...
const TextField: React.FC<TextFieldProps> = ({
  ...
  return (
    <form className={'relative flex w-full'} onSubmit={postSchedule}>
      <input
        className={
          'w-full px-[1.0625rem] py-[0.8125rem] pr-[3.6rem] outline-none text-Grey_06 body_03 bg-Grey_02 rounded-10 focus:outline-Grey_06 placeholder:text-Grey_04 placeholder:text-14'
        }
        type="text"
